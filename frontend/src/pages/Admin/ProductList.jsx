                ...
                <div className="md:w-3/4 p-3">
                    ...
                    {imageUrl && (
                        <div className="text-center">
                            <img src={imageUrl} alt="product" className="block mx-auto mah-h-[200px]" />
                        </div>
                    )}

                    <div className="mb-3">
                        <label className="border text-white px-4 block w-full text-center
                        rounded-lg cursor-pointer font-bold p-11">
                    ...
                    <div className="p-3">
                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="two ml-5">
                                <label htmlFor="name block">Artist</label> <br />
                                <input type="text" className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#101011] text-white" value={artist} onChange={(e) => setArtist(e.target.value)} />
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between">
                            ...
                            <div>
                                ...
                                <button className="py-4 px-10 mt-5 rounded-lg text-lg font-bold bg-indigo-800">Submit</button>
                    </div>
                </div>
            </div>
        </div>
